...
(`JvmHeapOverride`)|`**__Requires input__**`|Override the default amount of memory to allocate to the JVM for your instance type. Set size in MB or GB (e.g. 1024 MB or 1 GB).|Enable app to process email
