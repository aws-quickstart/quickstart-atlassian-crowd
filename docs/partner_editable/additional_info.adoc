...
By default, your Quick Start deployment will start with a single {partner-product-name-short} node (Auto Scaling group of `min=1` and `max=1`). Once you're ready to add nodes to your cluster, perform the following steps:
